...
public:
       ...
       void draw_solido_seleccionado(float r, float g, float b, int in);
       void draw_triangulo_seleccionado(float r, float g, float b, int in);
...
public:
       _soporte();
       void draw(_modo modo, float r1, float g1, float b1, float r2, float g2, float b2, float grosor, bool admiteSeleccion = false);
       void draw_seleccion_color(float r, float g, float b);
       void draw_seleccion_triangulos(float r, float g, float b);
