...
extern bool cambioColor[4];
extern int trianguloSelected;
...
//*************************************************************************
// dibujar en modo seleccion color
//*************************************************************************
...
//*************************************************************************
// dibujar en modo seleccion triangulos
//*************************************************************************
	...
	glPushMatrix();
		...
		glPushMatrix();
			...
			glPushMatrix();
				glTranslatef(0, 0, 5);
				if (cambioColor[1]) {
					soporte.draw(modo, 0, 1, 0, 0, 1, 0, grosor, true);
				} else {
					soporte.draw(modo, r1, g1, b1, r2, g2, b2, grosor, true);
				}
			glPopMatrix();
			...
			glPushMatrix();
				...
				if (cambioColor[0]) {
					soporte.draw(modo, 0, 1, 0, 0, 1, 0, grosor);
				} else {
			...
			glPushMatrix();
				...
				if (cambioColor[2]) {
					cuerpo.draw(modo, 0, 1, 0, 0, 1, 0, grosor);
				} else {
			...
			glPushMatrix();
				...
				if (cambioColor[3]) {
					cabeza.draw(modo, 0, 1, 0, 0, 1, 0, grosor);
				} else {
...
void _robot::draw_seleccion_color(float r, float g, float b)
{
	glPushMatrix();
		glTranslatef(0, -10, 0);
		glPushMatrix();
			...
			glPushMatrix();
				glTranslatef(0, 0, 5);
				soporte.draw_seleccion_triangulos(r, g, b);
			glPopMatrix();

			glPushMatrix();
				glTranslatef(0, 0, -5);
				glRotatef(180.0, 0, 1, 0);
				soporte.draw_seleccion_color(r+80, g+80, b+80);
			glPopMatrix();
			...
			glPushMatrix();
				glTranslatef(0, 3.5, 0);
				cuerpo.draw_seleccion_color(r+150, g+150, b+150);
			glPopMatrix();

			glRotatef(giro_cabeza, 0, 1, 0);
			glPushMatrix();
				glTranslatef(0, 14.5, 0);
				cabeza.draw_seleccion_color(r+175, g+175, b+175);
			glPopMatrix();
		glPopMatrix();
	glPopMatrix();
};
...
void _soporte::draw(_modo modo, float r1, float g1, float b1, float r2, float g2, float b2, float grosor, bool admiteSeleccion)
{
	glPushMatrix();
	...
	glScalef(2, 8.5, 1.5);
	if (admiteSeleccion && trianguloSelected != -1) {
		pata.draw_seleccion(r1, g1, b1);
	} else {
...
void _soporte::draw_seleccion_color(float r, float g, float b)
{
	glPushMatrix();
	glTranslatef(0, 0.5, 0);
	basePata.draw_seleccion_color(r, g, b);
	glPopMatrix();
	...
	glRotatef(90.0, 1, 0, 0);
	glScalef(1, 2.3, 1);
	rueda.draw_seleccion_color(r, g, b);
	glPopMatrix();
	...
	glTranslatef(0, 7.25, 1.25);
	glScalef(2, 8.5, 1.5);
	pata.draw_seleccion_color(r, g, b);
	glPopMatrix();
	...
	glRotatef(90.0, 1, 0, 0);
	glScalef(2, 3, 2);
	eje.draw_seleccion_color(r, g, b);
	glPopMatrix();

}

void _soporte::draw_seleccion_triangulos(float r, float g, float b)
{
	glPushMatrix();
	glTranslatef(0, 0.5, 0);
	basePata.draw_seleccion_color(r+12, g+12, b+12);
	glPopMatrix();
	...
	glRotatef(90.0, 1, 0, 0);
	glScalef(1, 2.3, 1);
	rueda.draw_seleccion_color(r+12, g+12, b+12);
	glPopMatrix();
	...
	glTranslatef(0, 7.25, 1.25);
	glScalef(2, 8.5, 1.5);
	pata.draw_seleccion_triangulos(r, g, b);
	glPopMatrix();
	...
	glRotatef(90.0, 1, 0, 0);
	glScalef(2, 3, 2);
	eje.draw_seleccion_color(r+12, g+12, b+12);
	glPopMatrix();
...
void _cuerpo::draw_seleccion_color(float r, float g, float b)
{
	glPushMatrix();
	glTranslatef(0, 0, 0);
	baseTronco.draw_seleccion_color(r, g, b);
	glPopMatrix();
...
void _cabeza::draw_seleccion_color(float r, float g, float b)
{
	glPushMatrix();
		glPushMatrix();
			glScalef(8, 8, 8);
			baseCabeza.draw_seleccion_color(r, g, b);
		glPopMatrix();

		glPushMatrix();
			glTranslatef(3, 2, 0);
			glScalef(1.8, 1.8, 1.8);
			ojo.draw_seleccion_color(r, g, b);
		glPopMatrix();

		glPushMatrix();
			glTranslatef(-2.6, 2 + altura_antena, -2);
			glScalef(0.4, 0.4, 0.4);
			bolaAntena.draw_seleccion_color(r, g, b);
		glPopMatrix();

		glPushMatrix();
			glTranslatef(-2.6, 2, -2);
			glScalef(0.1, altura_antena, 0.1);
			baseAntena.draw_seleccion_color(r, g, b);
		glPopMatrix();
	glPopMatrix();
